...
from sam3.model.sam3_image import (
    Sam3CrossImage,
    Sam3Image,
...
def build_sam3_image_model(
    ...
    Args:
        ...
        cross_image: If True, build Sam3CrossImage for cross-image prompting.
    ...
    model = _create_sam3_model(
        ...
        inst_predictor,
        eval_mode,
        model_cls=Sam3CrossImage if cross_image else Sam3Image,
    )
